...
export const TOKEN_AUDIENCE_ACCESS = process.env.JWT_AUDIENCE_ACCESS || 'access';
export const TOKEN_AUDIENCE_REFRESH = process.env.JWT_AUDIENCE_REFRESH || 'refresh';
...
export const REFRESH_CLOCK_TOLERANCE = Number(process.env.REFRESH_CLOCK_TOLERANCE) || 60;
...
export const CSRF_COOKIE_MAX_AGE = Number(process.env.CSRF_COOKIE_MAX_AGE) || 24 * 60 * 60 * 1000;

// SMS Configuration
export const SMS_API_URL = process.env.SMS_API_URL || 'https://s.api.ir/api/sw1/SmsOTP';
